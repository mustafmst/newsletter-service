...
- SMTP: `SMTP_HOST`, `SMTP_PORT`, `SMTP_USERNAME`, `SMTP_PASSWORD`, `SMTP_FROM_EMAIL`, `SMTP_FROM_NAME`, `SMTP_TLS_MODE`
...
- Sending and abuse protection: `SEND_DELAY`, `MAX_SEND_ATTEMPTS`, `TOKEN_TTL`, `RATE_LIMIT_PER_MINUTE`
